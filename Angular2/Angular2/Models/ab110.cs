 ...
 * Dependency	: This class refers ab110Data Entity class
...
namespace Angular2.Models
{
    ...
    public class ab110
    {
		...
		#region Constants
		private const string SP_GET_ALL = "SELECT  gkey, ba010gkey, ba010gkey1, ac002gkey1, ac002gkey2, ac002gkey3, ac002gkey4, ab041gkey1, accountno1, ab041gkey2, accountno2, clsdd, mmend, chkdd, payee, bankinfo, swift FROM dbo.ab110 WITH (NOLOCK)";
		private const string SP_GET_FILTER = "SELECT  gkey, ba010gkey, ba010gkey1, ac002gkey1, ac002gkey2, ac002gkey3, ac002gkey4, ab041gkey1, accountno1, ab041gkey2, accountno2, clsdd, mmend, chkdd, payee, bankinfo, swift FROM dbo.ab110 WITH (NOLOCK) {0}";
		private const string SP_GET_BYPAGE = "SELECT * FROM (SELECT ROW_NUMBER() OVER(ORDER BY {0}) AS rownumber, * FROM dbo.ab110 {1}) AS tblOutput WHERE rownumber BETWEEN {2} AND {3} SELECT COUNT(*) FROM dbo.ab110 WITH (NOLOCK) {4}";
		private const string SP_GET_BYID = "SELECT  gkey, ba010gkey, ba010gkey1, ac002gkey1, ac002gkey2, ac002gkey3, ac002gkey4, ab041gkey1, accountno1, ab041gkey2, accountno2, clsdd, mmend, chkdd, payee, bankinfo, swift FROM dbo.ab110 WITH (NOLOCK) WHERE gkey = @ref_id";
		private const string SP_ADD = "INSERT INTO dbo.ab110 ( gkey, ba010gkey, ba010gkey1, ac002gkey1, ac002gkey2, ac002gkey3, ac002gkey4, ab041gkey1, accountno1, ab041gkey2, accountno2, clsdd, mmend, chkdd, payee, bankinfo, swift) VALUES ( @gkey, @ba010gkey, @ba010gkey1, @ac002gkey1, @ac002gkey2, @ac002gkey3, @ac002gkey4, @ab041gkey1, @accountno1, @ab041gkey2, @accountno2, @clsdd, @mmend, @chkdd, @payee, @bankinfo, @swift) ";
		private const string SP_ADD1 = "INSERT INTO dbo.ab110 ( gkey, ba010gkey, ba010gkey1, ac002gkey1, ac002gkey2, ac002gkey3, ac002gkey4, ab041gkey1, accountno1, ab041gkey2, accountno2, clsdd, mmend, chkdd, payee, bankinfo, swift) VALUES ( @gkey, @ba010gkey, @ba010gkey1, @ac002gkey1, @ac002gkey2, @ac002gkey3, @ac002gkey4, @ab041gkey1, @accountno1, @ab041gkey2, @accountno2, @clsdd, @mmend, @chkdd, @payee, @bankinfo, @swift) SELECT @gkey = @@IDENTITY";
		private const string SP_UPDATE = "UPDATE dbo.ab110 SET ba010gkey = @ba010gkey, ba010gkey1 = @ba010gkey1, ac002gkey1 = @ac002gkey1, ac002gkey2 = @ac002gkey2, ac002gkey3 = @ac002gkey3, ac002gkey4 = @ac002gkey4, ab041gkey1 = @ab041gkey1, accountno1 = @accountno1, ab041gkey2 = @ab041gkey2, accountno2 = @accountno2, clsdd = @clsdd, mmend = @mmend, chkdd = @chkdd, payee = @payee, bankinfo = @bankinfo, swift = @swift WHERE gkey = @gkey";
		private const string SP_DELETE = "DELETE FROM dbo.ab110 WHERE gkey=@ref_id";
		private const string SP_DELETE_FILTER = "DELETE FROM dbo.ab110 {0}";
		private const string SP_GET_LOOKUP = "SELECT gkey, ba010gkey FROM dbo.ab110 WITH (NOLOCK)";
		#endregion
		
		#region ab110 - Constructor
		private ab110()
		{
			//
		...
		#region ab110 - List ab110 by Filter Expression
		/// <summary>
		...
		#region ab110 - List ab110 by filterExpression, sortExpression, pageIndex and pageSize
        /// <summary>
        ...
        #region ab110 - Get Details for an ab110 record
        /// <summary>
		...
		#region ab110 - Add Record
        /// <summary>
        /// Creates a new ab110 row.
        /// </summary>
        public static string Add( string gkey, string ba010gkey, string ba010gkey1, string ac002gkey1, string ac002gkey2, string ac002gkey3, string ac002gkey4, string ab041gkey1, string accountno1, string ab041gkey2, string accountno2, decimal clsdd, decimal mmend, decimal chkdd, string payee, string bankinfo, string swift)
        {
			try
			{
				using (SqlConnection cn = new SqlConnection(connectionString))
				{
					using (SqlCommand cmd = new SqlCommand(SP_ADD, cn))
					{
						...
						cmd.Parameters.AddWithValue("@ba010gkey", ba010gkey);
						cmd.Parameters.AddWithValue("@ba010gkey1", ba010gkey1);
		...
		#region ab110 - Update Record
        /// <summary>
        /// Updates a ab110
        /// </summary>
        public static bool Update( string gkey, string ba010gkey, string ba010gkey1, string ac002gkey1, string ac002gkey2, string ac002gkey3, string ac002gkey4, string ab041gkey1, string accountno1, string ab041gkey2, string accountno2, decimal clsdd, decimal mmend, decimal chkdd, string payee, string bankinfo, string swift)
        {
			try
			{
				using (SqlConnection cn = new SqlConnection(connectionString))
			...
			try
			{
				using (SqlConnection cn = new SqlConnection(connectionString))
				{
					using (SqlCommand cmd = new SqlCommand(SP_GET_ALL, cn))
					{
						...
						List<ab110Data> objList = new List<ab110Data>();
						while (reader.Read())
						{
							//objList.Add(new ab110Data(
							//	 (string) reader["gkey"], (string) reader["ba010gkey"], (string) reader["ba010gkey1"], (string) reader["ac002gkey1"], (string) reader["ac002gkey2"], (string) reader["ac002gkey3"], (string) reader["ac002gkey4"], (string) reader["ab041gkey1"], (string) reader["accountno1"], (string) reader["ab041gkey2"], (string) reader["accountno2"], (decimal) reader["clsdd"], (decimal) reader["mmend"], (decimal) reader["chkdd"], (string) reader["payee"], (string) reader["bankinfo"], (string) reader["swift"]));
							objList.Add(new ab110Data(reader)); // Use this to avoid null issues
						}
						return objList;    
					}
				}
		...
		/// </param>
		/// <returns>List of ab110Data object</returns>
		public static List<ab110Data> GetList(string filterExpression)
		{
			try
			{
				using (SqlConnection cn = new SqlConnection(connectionString))
        ...
        /// <param name="rowsCount">Output: Total number of rows exist for the specified criteria.</param>
        /// <returns>List of ab110Data object</returns>
        public static List<ab110Data> GetList(string filterExpression, string sortExpression, int pageIndex, int pageSize, out int rowsCount)
        {
			try
			{
				using (SqlConnection cn = new SqlConnection(connectionString))
		...
		#region ab110 - Get Details by ID
        /// <summary>
        /// Returns an existing ab110Data object with the specified ID 
        /// </summary>
        public static ab110Data GetDetailsByID(string sRefID)
        {
			try
			{
				using (SqlConnection cn = new SqlConnection(connectionString))
				{
					...
					if (reader.Read())
					{
						// return new ab110Data(
						//	 (string) reader["gkey"], (string) reader["ba010gkey"], (string) reader["ba010gkey1"], (string) reader["ac002gkey1"], (string) reader["ac002gkey2"], (string) reader["ac002gkey3"], (string) reader["ac002gkey4"], (string) reader["ab041gkey1"], (string) reader["accountno1"], (string) reader["ab041gkey2"], (string) reader["accountno2"], (decimal) reader["clsdd"], (decimal) reader["mmend"], (decimal) reader["chkdd"], (string) reader["payee"], (string) reader["bankinfo"], (string) reader["swift"]);
						return new ab110Data(reader); // Use this to avoid null issues
					}
					else
						return null;
				}
        ...
        /// Creates a new ab110
        /// </summary>
        public static string Add(ab110Data objab110)
        {
			try
			{
				using (SqlConnection cn = new SqlConnection(connectionString))
				{
					using (SqlCommand cmd = new SqlCommand(SP_ADD, cn))
					{
						...
						cmd.Parameters.AddWithValue("@gkey", objab110.gkey);
						cmd.Parameters.AddWithValue("@ba010gkey", objab110.ba010gkey);
						cmd.Parameters.AddWithValue("@ba010gkey1", objab110.ba010gkey1);
						cmd.Parameters.AddWithValue("@ac002gkey1", objab110.ac002gkey1);
						cmd.Parameters.AddWithValue("@ac002gkey2", objab110.ac002gkey2);
						cmd.Parameters.AddWithValue("@ac002gkey3", objab110.ac002gkey3);
						cmd.Parameters.AddWithValue("@ac002gkey4", objab110.ac002gkey4);
						cmd.Parameters.AddWithValue("@ab041gkey1", objab110.ab041gkey1);
						cmd.Parameters.AddWithValue("@accountno1", objab110.accountno1);
						cmd.Parameters.AddWithValue("@ab041gkey2", objab110.ab041gkey2);
						cmd.Parameters.AddWithValue("@accountno2", objab110.accountno2);
						cmd.Parameters.AddWithValue("@clsdd", objab110.clsdd);
						cmd.Parameters.AddWithValue("@mmend", objab110.mmend);
						cmd.Parameters.AddWithValue("@chkdd", objab110.chkdd);
						cmd.Parameters.AddWithValue("@payee", objab110.payee);
						cmd.Parameters.AddWithValue("@bankinfo", objab110.bankinfo);
						cmd.Parameters.AddWithValue("@swift", objab110.swift);
						cn.Open();
						int rowsAffected = cmd.ExecuteNonQuery();
						return (string)cmd.Parameters["@gkey"].Value;
					}
		...
		/// Updates a ab110
		/// </summary>
		public static bool Update(ab110Data objab110)
		{
			try
			{
				using (SqlConnection cn = new SqlConnection(connectionString))
